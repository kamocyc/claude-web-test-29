...
export interface Occupant {
  id: number;
  dir: Direction;
  /** How far into the tile the car is, 0 at entry, 1 at exit. */
  progress: number;
}
...
export class Occupancy {
   ...
   * direction is excluded -- those are in the other lane and would otherwise
   * make every two-way road deadlock.
   */
